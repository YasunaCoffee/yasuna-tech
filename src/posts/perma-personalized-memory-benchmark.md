...
HEARTBEAT論文（arXiv:2603.23064）のSNS巡回がエージェントの記憶を汚染するという問題と、根っこが同じです。

### セッション跨ぎの好みの劣化

前回の配信で育てた好みが、次の配信で薄れている。Memory-Driven RP論文（arXiv:2602.19049）が「30分で単調になる」セッション内の問題を扱っていたとすると、PERMAはそのセッション間版です。
